...
def main():
    ...
    if choice == 1:
        ...
        print(f"Cylindrical: (r: {r}, Î¸: {theta}, z: {z_cyl})")
        print("Converting to Spherical...")
        rho, theta_sph, phi = rectangular_to_spherical(x, y, z)
        print(f"Spherical: (Ï: {rho}, Î¸: {theta_sph}, Ï†: {phi})")
    
    elif choice == 2:
        r = sp.sympify(input("Enter r: "))
        theta = sp.sympify(input("Enter Î¸: "))
        z = sp.sympify(input("Enter z: "))
        ...
        rho = sp.sympify(input("Enter Ï: "))
        theta = sp.sympify(input("Enter Î¸: "))
        phi = sp.sympify(input("Enter Ï†: "))
        print("Converting to Rectangular...")
        ...
        print(f"Cylindrical: (r: {r}, Î¸: {theta_cyl}, z: {z})")
